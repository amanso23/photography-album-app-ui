export const backgrounds = {
  ...
  deepSpace: "bg-[linear-gradient(40deg,#000428,#004e92,#1e3a5f)]",
  sunset: "bg-[linear-gradient(40deg,#ff9a8b,#ff6a88,#ff99ac,#ff3c38)]",
  ocean: "bg-[linear-gradient(40deg,#005c97,#363795,#00a8cc,#4facfe)]",
  fire: "bg-[linear-gradient(40deg,#ff512f,#ff7849,#ff0062,#a80000)]",
